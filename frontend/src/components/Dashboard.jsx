    ...
    <div className="fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {loading
          ...
          : <>
              <StatCard icon={Database}   label="全网存证总数" value={stats.total_evidence_count} colorKey="purple" />
              <StatCard icon={Blocks}     label="当前区块高度" value={stats.current_block_height} colorKey="cyan" />
              <StatCard icon={FileCheck}  label="你的存证数量" value={stats.your_evidence_count} colorKey="green" />
              <StatCard icon={ShieldAlert} label="合约状态"    value={stats.contract_paused ? "已暂停" : "运行中"} colorKey="orange" />
            </>
        }
      </div>
